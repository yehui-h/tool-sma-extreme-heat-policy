...
const legacyDetailedRecommendationsByRisk: Record<RiskLevel, LegacyDetailedRecommendationContent> = {
  low: {
    description:
...
export const detailedSuggestionsByRisk: Record<RiskLevel, DetailedSuggestionsContent> = {
  low: {
    description: applyLegacyCapitalize(legacyDetailedRecommendationsByRisk.low.description),
    suggestions: parseLegacySuggestionBullets(legacyDetailedRecommendationsByRisk.low.suggestion),
  },
  moderate: {
    description: applyLegacyCapitalize(legacyDetailedRecommendationsByRisk.moderate.description),
    suggestions: parseLegacySuggestionBullets(legacyDetailedRecommendationsByRisk.moderate.suggestion),
  },
  high: {
    description: applyLegacyCapitalize(legacyDetailedRecommendationsByRisk.high.description),
    suggestions: parseLegacySuggestionBullets(legacyDetailedRecommendationsByRisk.high.suggestion),
  },
  extreme: {
    description: applyLegacyCapitalize(legacyDetailedRecommendationsByRisk.extreme.description),
    suggestions: parseLegacySuggestionBullets(legacyDetailedRecommendationsByRisk.extreme.suggestion),
  },
}
