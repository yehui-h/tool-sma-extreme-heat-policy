import { SportType, toSportAssetName, type SportType as SportTypeValue } from '@/features/home/domain/sportType'
...
export const SPORT_VALUES: SportTypeValue[] = SPORT_OPTIONS.map((option) => option.value)

export const DEFAULT_SPORT_TYPE = SportType.Soccer

export const SPORT_IMAGE_BY_TYPE: Record<SportTypeValue, string> = SPORT_VALUES.reduce<
  Record<SportTypeValue, string>
>(
  (acc, sportType) => {
